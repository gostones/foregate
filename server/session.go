...
const cookieKey = "foregate_session"

var cookieConfig *Config

type ForegateSession struct {
	Key       string `json:"key"`
	Port      int    `json:"port"`
	Timestamp int64  `json:"timestamp"`
}

func SetCookie(w http.ResponseWriter, v *ForegateSession) error {
	return setCookie(w, v, cookieConfig)
}

func GetCookie(r *http.Request, v *ForegateSession) error {
